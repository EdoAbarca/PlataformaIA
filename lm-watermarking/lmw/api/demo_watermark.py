...
def main(args):
    ...
    data = {
        "watermark_result": with_watermark_detection_result,
        "non_watermark_result": without_watermark_detection_result
    }

    print("[demo_watermark.py] JSON de salida generado: ", data)
